        ...
        <header>
            ...
            <div id="iconUser" class="profile">
                 ...
                 <div class="profile-card">
                    <div class="image"><img src="./user-icon.png" alt="" class="profile-pic"></div>
                                <?php 
            ...
            <?php             
                ...
                foreach ($statement as $row) {    
                    ...
                    echo '<input type="number" name="my_amount" value="'. $row["amount"].'" max="'. $row["amount"].'" min="1" value="1" required>';
                    echo '<input type="text" name="my_comment" max="50"  value="no comment">';
                    echo '</div>'; 
        ...
        <?php
            ...
            ?>
                ...
                if ($counter >0) {
                    ?>
                    <div class="buttons">
                    <button class="print-invoice" onclick="printInvoice()"><i class="icon-printer"></i></button>
